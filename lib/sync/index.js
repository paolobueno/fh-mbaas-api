...
function listCollisions(dataset_id, params, cb) {
  ...
  return server.dataHandlers.listCollisions(dataset_id, params.meta_data, cb);
}
...
function removeCollision(dataset_id, params, cb) {
  ...
  return server.dataHandlers.removeCollision(dataset_id, params.hash, params.meta_data, cb);
}
...
_.each(handlerOverrides, function(target, methodName) {
  module.exports.api[methodName] = function() {
    server.dataHandlers[target].apply(null, arguments);
  };
});
